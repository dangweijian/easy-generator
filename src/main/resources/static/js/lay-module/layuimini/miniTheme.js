        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://github.com/dangweijian/easy-generator" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i>GitHub</a>\n' +
                    '<a class="more-menu-item" href="https://gitee.com/dwjian/easy-generator" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i>Gitee</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
